...
@section('content')
    <div class="container-fluid">
        <h4 class="page-title mt-4">Tambah Kategori Produk</h4>
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form action="{{ route('kategori.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control" id="deskripsi" rows="4" placeholder="Deskripsi kategori...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
